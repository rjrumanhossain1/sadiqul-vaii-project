<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <!-- Layouts -->
      <li class="menu-item {{ (request()->is(['admin/subcategory', 'admin/category', 'admin/subcategory','admin/product','admin/add-product'])) ? 'open' : '' }}">
        ...
        <ul class="menu-sub">
          <li class="menu-item ">
            <a href="{{ route('admin.add.product') }}" class="menu-link {{ (request()->is('admin/add-product')) ? 'active' : '' }}">
