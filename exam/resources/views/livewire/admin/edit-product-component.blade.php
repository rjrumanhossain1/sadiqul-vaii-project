                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" wire:model="newimage" type="file" id="formFile">
                                        @if($newimage)
                                            <img src="{{ $newimage->temporaryUrl() }}" alt="image not found" style="width:100px;margin-top:10px;">
                                        @else
                                            <img src=" {{asset('uploads') }}/{{ $image }} " alt="" style="width:100px;margin-top:10px;">
                                        @endif
                                    </div>
